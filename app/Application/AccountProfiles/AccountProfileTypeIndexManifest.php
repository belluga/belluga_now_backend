...
final class AccountProfileTypeIndexManifest
{
    ...
    public function definitions(): array
    {
        $definitions = [
            ...
            $this->definition('M-04', 'U04', 'publiclyDiscoverable', 'idx_account_profile_types_public_discovery_v1', ['capabilities.is_queryable' => 1, 'capabilities.is_publicly_discoverable' => 1, 'type' => 1], 'discoverable type-set read'),
            $this->definition('M-05', 'U04', 'publicCatalog', 'idx_account_profile_types_public_catalog_v2', ['capabilities.is_queryable' => 1, 'capabilities.is_publicly_discoverable' => 1, 'capabilities.is_favoritable' => 1, 'type' => 1], 'U07 direct catalog snapshot'),
            $this->definition('M-06', 'U04', 'publicPoiCatalog', 'idx_account_profile_types_public_poi_catalog_v2', ['capabilities.is_queryable' => 1, 'capabilities.is_publicly_discoverable' => 1, 'capabilities.is_favoritable' => 1, 'capabilities.is_poi_enabled' => 1, 'type' => 1], 'U07 near-only public POI read'),
            $this->definition('M-07', 'U04', 'queryable->poiEnabled', 'idx_account_profile_types_queryable_poi_enabled_v1', ['capabilities.is_queryable' => 1, 'capabilities.is_poi_enabled' => 1, 'type' => 1], 'Event venue/place resolver'),
            $this->definition('M-08', 'U04', 'queryable->publiclyNavigable->poiEnabled', 'idx_account_profile_types_queryable_public_navigation_poi_enabled_v1', ['capabilities.is_queryable' => 1, 'capabilities.is_publicly_navigable' => 1, 'capabilities.is_poi_enabled' => 1, 'type' => 1], 'Event public place resolver'),
        ];
