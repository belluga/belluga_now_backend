...
class ApiDefaultAccountAuthTest extends TestCaseAuthenticated {
    ...
    protected string $tenant_2_account_user_admin_token_device_2 {
        set(string $value) {
            $this->setGlobal(TestVariableLabels::TENANT_2_ACCOUNT_USER_ADMIN_DEVICE_2_TOKEN->value, $value);
            $this->tenant_2_account_user_admin_token_device_2 = $value;
        }
        get {
            return $this->getGlobal(TestVariableLabels::TENANT_2_ACCOUNT_USER_ADMIN_DEVICE_2_TOKEN->value);
        }
    }
    ...
    public function testUserLoginWrongPassword(): void {
        ...
        $response = $this->userLogin(
            data: [
                "email" => $this->tenant_2_account_user_admin_email_2,
                "password" => fake()->password(8),
                "device_name" => "test",
            ]
        );
    ...
    public function testUserLoginLogoutManyDevicesSuccess(): void {
        ...
        $responseUserAdmin->assertStatus(200);
        $this->tenant_2_account_user_admin_token_device_2 = $responseUserAdmin->json()['data']['token'];
        ...
        $this->tenant_2_account_user_admin_token_device_1 = "";
        $this->tenant_2_account_user_admin_token_device_2 = "";
