...
class ApiDefaultAdminRolesTest extends TestCaseAuthenticated
{
    protected string $role_id {
        get {
            return $this->getGlobal(TestVariableLabels::ROLE_ID->value);
        }
        set(string $value) {
            $this->setGlobal(TestVariableLabels::ROLE_ID->value, $value);
            $this->role_id = $value;
        }
    }
